...
writefile("bbotui.ttf", game:HttpGet("fontlink"))
...
local UIGradient_2 = Instance.new("UIGradient")
	...
	UIGradient.Rotation = -90
	UIGradient.Parent = IndInline

	TitleText.Name = "TitleText"
	TitleText.Parent = IndInline
	TitleText.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	TitleText.BackgroundTransparency = 1.000
	TitleText.BorderColor3 = Color3.fromRGB(0, 0, 0)
	TitleText.BorderSizePixel = 0
	TitleText.Position = UDim2.new(0, 4, 0, 0)
	TitleText.Size = UDim2.new(-0.575523257, 0, 1, 0)
	TitleText.FontFace = realfont
	TitleText.Text = Text
	TitleText.TextColor3 = Color3.fromRGB(255, 255, 255)
	TitleText.TextSize = 12.000
	TitleText.TextStrokeTransparency = 0.000
	...
	UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(55, 55, 55))}
	UIGradient_2.Rotation = 90
	UIGradient_2.Parent = Accent

	function Table:SetVisible(Value)
		Title.Visible = Value
	end
	function Table:SetTitle(String)
